...
// Generated for vulkan version: 1.0.64
...
using PfnGetShaderInfoAMD = Result(*VKAPI_PTR)(Device device, Pipeline pipeline, ShaderStageBits shaderStage, ShaderInfoTypeAMD infoType, size_t* pInfoSize, void* pInfo);
...
using PeerMemoryFeatureFlagsKHX = Flags<PeerMemoryFeatureBitsKHX>;
using MemoryAllocateFlagsKHX = Flags<MemoryAllocateBitsKHX>;
using DeviceGroupPresentModeFlagsKHX = Flags<DeviceGroupPresentModeBitsKHX>;
...
using CommandPoolTrimFlagsKHR = Flags<DummyEnum>;
...
using ExternalMemoryHandleTypeFlagsKHR = Flags<ExternalMemoryHandleTypeBitsKHR>;
using ExternalMemoryFeatureFlagsKHR = Flags<ExternalMemoryFeatureBitsKHR>;
...
using ExternalSemaphoreHandleTypeFlagsKHR = Flags<ExternalSemaphoreHandleTypeBitsKHR>;
using ExternalSemaphoreFeatureFlagsKHR = Flags<ExternalSemaphoreFeatureBitsKHR>;
...
using SemaphoreImportFlagsKHR = Flags<SemaphoreImportBitsKHR>;
...
using DescriptorUpdateTemplateCreateFlagsKHR = Flags<DummyEnum>;
...
using ExternalFenceHandleTypeFlagsKHR = Flags<ExternalFenceHandleTypeBitsKHR>;
using ExternalFenceFeatureFlagsKHR = Flags<ExternalFenceFeatureBitsKHR>;
...
using FenceImportFlagsKHR = Flags<FenceImportBitsKHR>;
